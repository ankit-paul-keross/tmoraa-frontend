...
export default function BenefitSection() {
    return (
        ...
        <div className="relative bg-[url('/benefit-bg.png')] bg-cover bg-center h-fit">
            ...
            <img src="/card-bg-bottom.png" alt='' className='absolute right-[10.5%] top-[77.5%] h-20 w-20 object-cover' />
            <div className='flex'>
                ...
                <div className="my-25 ml-88 bg-background rounded-2xl w-[36%] z-10"></div>
            </div>
